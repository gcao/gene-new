...
let GET_CHILD_KEY*            = add_key("get_child")
let SET_CHILD_KEY*            = add_key("set_child")
...
let CWD_KEY*                  = add_key("$cwd")
let DIR_KEY*                  = add_key("$dir")
let FILE_KEY*                 = add_key("$file")
let USER_KEY*                 = add_key("$user")
let HOME_KEY*                 = add_key("$home")
let ADD_KEY*                  = add_key("+")
let SUB_KEY*                  = add_key("-")
let MUL_KEY*                  = add_key("*")
let DIV_KEY*                  = add_key("/")
